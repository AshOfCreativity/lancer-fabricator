...
import { NPC_STATUSES, STATUS_WHERE, STATUS_TYPE, getStatusDef, getStatusesForActor, findStatusesForFeature, hasModifiersEquipped, autoGenerateStatus, getAutoGeneratedDef } from "./npc-status-data.mjs";
